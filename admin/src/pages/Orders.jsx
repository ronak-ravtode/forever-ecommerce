      ...
      <div>
        {
          orders.map((order, idx) => (
            <div className='grid grid-cols-1 sm:grid-cols-[0.5fr_2fr_1fr] lg:grid-cols-[0.5fr_2fr_1fr_1fr_1fr] gap-3 items-start border-2 border-gray-200 md:p-8 p-5 my-3 md:my-4 text-xs sm:text-sm text-gray-700' key={idx}>
